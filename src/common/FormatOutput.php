...
/**
 * @class FormatOutput
 * @method static void red($text, $background = '')
 * @method static void yellow($text, $background = '')
 * @method static void green($text, $background = '')
 * @method static void blue($text, $background = '')
 *
 */
class FormatOutput
{
